...
Faster, and more scalable than both the default Community Edition connection_per_thread handler ([see benchmarks](https://github.com/Damienkatz/thrustdb_benchmarks/blob/main/thread_pool_hybrid-vs-connection_per_thread-mysql_8.0.4-ubuntu_24.04-on-r5.8xlarge.md)) and Enterprise Edition thread pool handler ([see benchmarks](https://github.com/Damienkatz/thrustdb_benchmarks/blob/main/thread_pool_hybrid_vs_enterprise_thread_pool-mysql-9.0.3-redhat_9.0.4-r7i.4xlarge.md)).
